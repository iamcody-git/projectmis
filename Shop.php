      ...
      <section id="featured " class="my-5 py-5">
        ...
        <div class="row mx-auto container">
          <div onclick="window.location.href='single_pdt.php'" class="product text-center col-lg-3 col-md-4 col-sm-12">
            <img  class="img-fluid mb-3" src="Frontend/Images/brand3.png"/>
            <div class="star">
          ...
          <div onclick="window.location.href='single_pdt.php'"  class="product text-center col-lg-3 col-md-4 col-sm-12">
            <img  class="img-fluid mb-3" src="Frontend/Images/watch.webp"/>
            <div class="star">
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
          ...
          <div onclick="window.location.href='single_pdt.php'"  class="product text-center col-lg-3 col-md-4 col-sm-12">
            <img  class="img-fluid mb-3" src="Frontend/Images/fotimg1.jpeg"/>
            <div class="star">
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
          ...
          <div onclick="window.location.href='single_pdt.php'"  class="product text-center col-lg-3 col-md-4 col-sm-12">
            <img  class="img-fluid mb-3" src="Frontend/Images/fotimg3.jpeg"/>
            <div class="star">
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
          ...
          <div onclick="window.location.href='single_pdt.php'"  class="product text-center col-lg-3 col-md-4 col-sm-12">
            <img  class="img-fluid mb-3" src="Frontend/Images/fotimg2.jpeg"/>
            <div class="star">
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
          ...
          <div onclick="window.location.href='single_pdt.php'"  class="product text-center col-lg-3 col-md-4 col-sm-12">
            <img  class="img-fluid mb-3" src="Frontend/Images/fotimg5.jpeg"/>
            <div class="star">
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
          ...
          <div onclick="window.location.href='single_pdt.php'"  class="product text-center col-lg-3 col-md-4 col-sm-12">
            <img  class="img-fluid mb-3" src="Frontend/Images/fotimg6.jpeg"/>
            <div class="star">
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
          ...
          <div onclick="window.location.href='single_pdt.php'"  class="product text-center col-lg-3 col-md-4 col-sm-12">
            <img  class="img-fluid mb-3" src="Frontend/Images/fotimg4.jpeg"/>
            <div class="star">
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
              <ion-icon name="star-outline"></ion-icon>
